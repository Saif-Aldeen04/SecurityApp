...
public class Encryption {
    ...
    Encryption(StringBuilder message){
        this.message = message ;
    }

    //Constractor to take message and key.
    Encryption(StringBuilder message, int key){
        this.message = message ;
        this.key = key;
    }
    ...
    //This function to encrypte any message with specific key.
    public void encryptionMessage(StringBuilder message,int key){
        ...
        for(int i = 0; i < length; i++){
            ...
            //This line to calculate the new ASCII code of new charater.
            tempNum += key;

            //The 2 block to still in the range of characters.
            if(tempNum > 122 && !capital){
                while(tempNum > 122){
                    tempNum -= 26;
                }
            }

            if(tempNum > 90 && capital){
                while(tempNum > 90){
                    tempNum -= 26;
                }
            }
    ...
    //This function to encrypte any message with key = 3.
    public void encryptionMessage(StringBuilder message){
